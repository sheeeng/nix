...
Added `treefmt-vscode` extension from [GitHub repository][treefmt-vscode-repo] by adding the following to the VS Code configuration:
...
[treefmt-vscode-repo]: https://github.com/isbecker/treefmt-vscode
