{
  ...
  inputs = {
    ...
    # OK
    nixpkgs-darwin.url = "github:nixos/nixpkgs?branch=nixpkgs-unstable&rev=0813ec5292fe3184ededa5995a5944f72d65804b"; # @upstream-issue https://github.com/anomalyco/opencode/issues/8029
