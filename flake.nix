{
  ...
  inputs = {
    ...
    # OK
    nixpkgs-darwin.url = "github:nixos/nixpkgs?branch=nixpkgs-unstable&rev=0eb539e65647b5d0282fecc937b77144e9d7965f"; # @upstream-issue https://github.com/anomalyco/opencode/issues/8029
