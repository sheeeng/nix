  ...
  home.packages = with pkgs; [
    ...
    (ruby.withPackages (
      pkgs: with pkgs; [
        ...
        nokogiri # @upstream-issue https://github.com/NixOS/nixpkgs/pull/450512#issuecomment-3390505837 # https://search.nixos.org/packages?channel=unstable&type=packages&show=rubyPackages.nokogiri
