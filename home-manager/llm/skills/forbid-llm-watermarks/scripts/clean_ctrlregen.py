...
from common import cleaned_path, safe_write_bytes
...
def main() -> int:
    ...
    p.add_argument(
        "-o", "--output", type=Path, help="Output path (default: *.ctrlregen.*)"
    )
    p.add_argument(
        "--upstream-dir",
        type=Path,
    ...
    try:
        from ctrlregen.engine import (
            CtrlRegenEngine,
            is_ctrlregen_available,
        )
