{ pkgs, ... }:
{
  ...
  programs.neovide = {
    enable = false; # pkgs.stdenv.hostPlatform.isLinux || (pkgs.stdenv.hostPlatform.isDarwin && pkgs.stdenv.hostPlatform.isAarch64); # https://nix-community.github.io/home-manager/options.xhtml#opt-programs.neovide.enable
