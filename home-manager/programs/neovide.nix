{ pkgs, ... }:
{
  ...
  programs.neovide = {
    enable = pkgs.stdenv.isLinux || (pkgs.stdenv.isDarwin && pkgs.stdenv.hostPlatform.isAarch64); # https://nix-community.github.io/home-manager/options.xhtml#opt-programs.neovide.enable
