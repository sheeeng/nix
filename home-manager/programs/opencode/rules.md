...
Follow Chicago Manual of Style for all comments and documentation.
...
- Use imperative verbs to start a sentence whenever possible.

For title case, apply these rules:
...
- Exception: Capitalize prepositions when used adverbially or adjectivally or in verb phrases.
- Do not use normal dashes or proper em dashes.
- Do not use parenthesis to phrase terms.
- Do not use config term, use configuration.
