{ pkgs, ... }:
{
  programs.zsh = {
    zsh-abbr = {
      ...
      package = pkgs.zsh-abbr; # https://nix-community.github.io/home-manager/options.xhtml#opt-programs.zsh.zsh-abbr.package
      abbreviations = {
        gco = "git checkout";
        l = "less";
      ...
      globalAbbreviations = { }; # https://nix-community.github.io/home-manager/options.xhtml#opt-programs.zsh.zsh-abbr.globalAbbreviations
    };
  };
}
